...
from cvxpy.reductions.solvers.conic_solvers.clarabelgpu_conif import ClarabelGPU as ClarabelGPU_con
...
solver_conic_intf = [DIFFCP_con(), ECOS_con(),
                     ...
                     QOCO_con(), CUCLARABEL_con(), CUOPT_con(), ECOS_BB_con(), ClarabelGPU_con()]
